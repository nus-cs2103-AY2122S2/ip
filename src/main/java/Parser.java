...
public class Parser {
    ...
    void run() throws DukeException, IOException {
        ...
        while (!cmd.equals("bye")) {
            if (cmd.equals(Duke.Commands.LIST.command)) {
                listTasks();

            } else if (cmd.equals(Duke.Commands.MARK.command)) {
                int taskNumber = 0;
                taskNumber = sc.nextInt();
                mark(taskNumber);

            } else if (cmd.equals(Duke.Commands.UNMARK.command)) {
                int taskNumber = 0;
                taskNumber = sc.nextInt();
                unmark(taskNumber);

            } else if (cmd.equals(Duke.Commands.TODO.command)) {
            ...
            } else if (cmd.equals(Duke.Commands.DEADLINE.command)) {
            ...
            } else if (cmd.equals(Duke.Commands.EVENT.command)) {
                String info = sc.nextLine();
            ...
            } else if (cmd.equals(Duke.Commands.DELETE.command)) {
