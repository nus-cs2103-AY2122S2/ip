...
public class UI {
    ...
    public static void showStarting(){ writer.println("Starting Application...");}

    // Error Messages
    public static void showInvalidIntegerError()    { writer.println("Invalid number entered! Please enter an integer");}
    public static void showInvalidDateTimeError()   { writer.println("Invalid Date/Time!");}
    public static void showInvalidTaskNameError()   { writer.println("Invalid Task Name!");}
    ...
    public static void showMarkOutOfBounds()    { writer.println("Invalid number entered! No tasks marked.");}
    public static void showUnmarkOutOfBounds()  { writer.println("Invalid number entered! No tasks unmarked.");}
    public static void showMarkEmptyList()      { writer.println("There are no tasks in your task list to mark");}
    public static void showUnmarkEmptyList()    { writer.println("There are no tasks in your task list to unmark");}
    ...
    // Save/Load Files
    public static void showInitializeDefaults() { writer.println("...Initializing Defaults...");}
    public static void showFileNotFound()       { writer.println("Data File not found!");}
    public static void showFileReadError()      { writer.println("Error Reading from file!");}
    public static void showDirNotFound()        { writer.println("Directory not found!");}
    public static void showDirCreating(String s){ writer.printf("Creating %s...",s);}
    public static void showDirCreated()         { writer.println("Directory Created!");}
    public static void showLoadingComplete()    { writer.println("Loading Completed!");}
    public static void showSavingComplete()     { writer.println("Saving Completed!");}
    public static void showTaskLoadFail(String input)       { writer.println("Task not loaded. Details: " + input);}
