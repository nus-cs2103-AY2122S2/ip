...
public class Duke {
    ...
    //private Image user = new Image(this.getClass().getResourceAsStream("/image/clown.jpg"));
    //private Image duke = new Image(this.getClass().getResourceAsStream("/image/snorlax.png"));
