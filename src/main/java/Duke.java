                        ...
                        switch (inputCommand) {
                            case MARK:
                                ...
                                try {
                                    ...
                                    System.out.println("\t\t" + tasks.get(taskNumMark).track() + tasks.get(taskNumMark).status
                            ...
                            case UNMARK:
                                ...
                                try {
                                    ...
                                    System.out.println("\t\t" + tasks.get(taskNumUnmark).track() + tasks.get(taskNumUnmark).status
