        ...
        while (!(userInput.equals("bye")))
        {
            ...
            else if (split[0].equals("help"))
            {
                System.out.println("try the following commands:\n" +
                        "   list (lists out all tasks in your todo list)\n" +
                        "   todo <task> (adds a basic task to your todo list)\n" +
                        "   deadline <task> /by <date> (adds a task with a deadline to your todo list)\n" +
                        "   event <task> /at <date> (adds a new event with its corresponding date to your todo list)\n" +
                        "   mark <task index> (marks that specific task as completed)\n" +
                        "   unmark <task index> (removes mark from specific task)\n" +
                        "   delete <task index> (removes task from todo list)\n" +
