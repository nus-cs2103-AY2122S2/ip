...
public class Duke {
    ...
    class Deadlines extends Task {
        ...
        public Deadlines(String taskName, LocalDate dateline) {
            super(taskName);
        ...
        while (!command.equals("bye")) {
            if (command.equals("list")) {
                ...
                switch (commandSplit[0]) {
                    ...
                    case "deadline":
                        switch (commandSplit[1].split(" ")[0]) {
                            case "/by":
                                try {
                                    System.out.println(commandSplit[1].split("/by ", 2)[1]);
                                    StringBuilder sb1 = new StringBuilder("");
                                    LocalDate datelineDate = LocalDate.parse(commandSplit[1].split("/by ", 2)[1]);
                            ...
                            default:
                                try {
                                    Deadlines newTask1 = new Duke().new Deadlines(commandSplit[1].split(" /by ", 2)[0],
                                            LocalDate.parse(commandSplit[1].split(" /by ", 2)[1]));
                                    ...
                                    System.out.println(hyphenate);
                                    System.out.println("");
                                    System.out.println("       YIKES!!! Please enter a valid date.");
                                    System.out.println(hyphenate);
                                }
                                break;
                        }
                    ...
                    case "event":
                        try {
                            Events newTask2 = new Duke().new Events(commandSplit[1].split(" /at ", 2)[0],
