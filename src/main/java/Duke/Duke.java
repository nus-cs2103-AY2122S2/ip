...
//    }
//
//    public static void processFind(String keyword, ArrayList<Task> taskList) {
//        printMessage(DukeMessage.getTaskMsg);
//        for (int i = 0; i < taskList.size(); i++) {
...
//            }
//            else if (userinput.startsWith(DukeCommand.find)) {
//                String findStr = userinput.substring(DukeCommand.find.length()).trim();
//                processFind(findStr, taskList);
//            }
//            else {
//                printMessage(DukeMessage.invalidCommandMsg);
//            }
