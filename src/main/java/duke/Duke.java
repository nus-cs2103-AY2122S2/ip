...
public class Duke extends Application {
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/drake.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/kwest.png"));
