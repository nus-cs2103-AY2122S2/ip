...
//    private Image duke = new Image(this.getClass().getResourceAsStream("/images/DaDuke.jfif"));
...
//    }
     ...
     * the dialog container. Clears the user input after processing. Also flips Duke's dialog box.
     */
