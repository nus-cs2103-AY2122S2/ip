...
public class Duke extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/isabell.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/kkslider.png"));
