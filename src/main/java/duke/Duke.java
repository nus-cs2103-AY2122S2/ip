...
//
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/qiyu.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/longjuan.png"));
    ...
    private void handleUserInput() {
        ...
        dialogContainer.getChildren().addAll(
                new DialogBox(userText.getText(), user),
                new DialogBox(dukeText.getText(), duke)
        );
        userInput.clear();
    }
