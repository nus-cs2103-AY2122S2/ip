...
public class Duke extends Application {
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/soccat.jpeg"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/bear.png"));
