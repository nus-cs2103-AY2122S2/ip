...
public final class Message {
    ...
    public static final String NO_SCHEDULE = LINE_PREFIX + "You do not have any schedule for ";
    public static final String LIST_SCHEDULE = LINE_PREFIX + "Here is your schedule for ";
