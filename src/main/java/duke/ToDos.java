...
public class ToDos extends Task {
    ...
    /**
     * An alternative constructor used to instantiate a ToDos
    ...
    /**
     * Returns the String representation of the ToDos class for
     * user to read.
     *
    ...
    /**
     * Returns the String presentation of the ToDos class for
     * writing into the duke.txt file.
     *
     * @return A String representing the ToDos class for the
     * duke.txt file.
     */
