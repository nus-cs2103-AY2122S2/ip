...
public class Messages {
    ...
    public static final String MESSAGE_FILE_PATH = "Current file path: ";
    public static final String MESSAGE_PROMPT = "What can I do for you";
    ...
    public static final String MESSAGE_ERROR_INVALID_COMMAND = "☹ OOPS!!! I'm sorry, but I don't know what that means :-(";
