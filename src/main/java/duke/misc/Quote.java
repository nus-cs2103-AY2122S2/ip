...
public class Quote {
     ...
     */
    public Quote() {
        alQuotes = new ArrayList<String>(Arrays.asList(
                "Life is more than what is, its what it could be. What you could make it.\n",
                ...
                "What we need to recognise is that the things we truly want, the things "
                ...
                "So many of us choose our path out of fear disguised as practicality. \n"
                        + "What we really want seems impossibly out of reach and ridiculous to"
                        + " expect so we never dare to ask the universe for it. \n"
