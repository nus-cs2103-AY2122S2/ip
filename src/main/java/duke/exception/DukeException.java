...
public class DukeException extends Exception {
    ...
    public static final String FORMAT_DEADLINE = "Try using:\"deadline <task_name> /by <deadline> [/p <priority>].\"";
    public static final String FORMAT_EVENT = "Try using:\"event <task_name> /by <event_time> [/p <priority>].\"";
