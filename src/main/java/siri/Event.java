...
/**
 * Class for the event items of the tasklist, with int done to be indicative of whether the task had been completed,
 * String item to be the name of the task, LocalDate eventDate as the date for the event, and LocalTime eventTime
 * as time for the event.
 */
...
class Event extends Task {
    ...
    public String getTaskDetails() {
        String taskDetails = "[E]" + super.getTaskDetails()
                + " (at: " + this.eventDate.format(Event.dtf) + " " + this.eventTime + ")";
        return taskDetails;
    }
    ...
    public String saveData() {
        ...
        String dataString = "E " + String.valueOf(this.isDone) + " " + this.item
                + " /at " + this.eventDate.format(dateFormat) + " " + this.eventTime.format(timeFormat);
        return dataString;
    }
}
