...
public class MainWindow extends AnchorPane {
    ...
    private Function<String, String> processQuery;
    ...
    public void setProcessQuery(Function<String, String> processQuery) {
    ...
    private void handleUserInput() {
        ...
        final String response = this.processQuery.apply(input);
