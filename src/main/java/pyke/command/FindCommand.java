...
public class FindCommand extends Command {
    ...
    public String executeUi(TaskList taskList, Ui ui, Storage storage) {
        if (taskList.isEmpty()) {
            ...
            if (cnt != 0) {
                return ui.outputUiText("Here are the matching tasks in your list:" + outputText);
            } else {
                return ui.outputUiText("Sorry! I couldn't find any task which contains that keyword.");
            }
        }
    }
