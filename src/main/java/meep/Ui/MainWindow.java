...
public class MainWindow extends AnchorPane {
    ...
    private Image sendLogo = new Image(this.getClass().getResourceAsStream("/images/send.jpeg"));
    ...
    public void setDuke(Gui d) {
        ...
        dialogContainer.getChildren().addAll(
                DialogBox.getDukeDialog(Messages.MESSAGE_HI, dukeImage),
                DialogBox.getDukeDialog(gui.showTasks(), dukeImage)
        );
    }
