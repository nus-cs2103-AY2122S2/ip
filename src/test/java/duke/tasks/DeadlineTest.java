...
public class DeadlineTest {
    ...
    public void encodeTaskToString_callingMethod_outputShownCorrectly() throws DukeException {
        String expectedResult = new Deadline("IP Project", "2/12/2019 6PM").encodeTaskToString();
        String actualResult = "D|0|IP Project|2019-12-02 18:00\n";
        assertEquals(expectedResult, actualResult);
    }

    @Test
    public void encodeTaskToString_callingMethodWithDiffInput_outputShownCorrectly() throws DukeException {
        String expectedResult = new Deadline("return book", "2/12/2019 0900").encodeTaskToString();
