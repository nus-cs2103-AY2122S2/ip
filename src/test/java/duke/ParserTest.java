...
public class ParserTest {
    ...
    public void parserDeadlineTest_createDeadlineTask_success() throws DukeException, IOException {
        ...
        Parser parser = new Parser( tasks, storage);
        String output = parser.parseInput("deadline Assignment /by 2022/May/14");        assertEquals(expected, output);
    }
    ...
    public void parserEventTest_createEventTask_success() throws DukeException, IOException {
        ...
        Parser parser = new Parser( tasks, storage);
        String output = parser.parseInput("event Project Meeting /at 2022/January/30");        assertEquals(expected, output);
    }
}
