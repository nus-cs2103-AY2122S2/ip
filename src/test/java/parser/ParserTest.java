...
public class ParserTest {
    ...
    public void checkTaskFormat_normalInput_success() throws InvalidInputException {
        ...
        assertEquals("test", parser.checkTaskFormat("test"));
    }
    ...
    public void checkPrepositionFormat_normalInput_success() throws InvalidInputException {
        Parser parser = new Parser();
        assertEquals("02/12/2019 18:00", parser.checkPrepositionFormat("by 02/12/2019 18:00", AddCommand.COMMAND_DEADLINE));
        assertEquals("02/12/2019 18:00", parser.checkPrepositionFormat("on 02/12/2019 18:00", AddCommand.COMMAND_EVENT));
        assertEquals("02/12/2019 18:00", parser.checkPrepositionFormat("at 02/12/2019 18:00", AddCommand.COMMAND_EVENT));
    }
    ...
    public void parseDate_invalidInput_exceptionThrown() {
        ...
        assertEquals("'" + invalidDate + "' can't be formatted! Please format the date/time as dd/MM/yyyy HH:mm", thrown.getMessage());
    }
