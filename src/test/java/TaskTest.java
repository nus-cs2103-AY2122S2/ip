...
public class TaskTest {
    ...
    public void testToStringForEvent() {
        LocalDateTime checkDateAndTime = LocalDateTime.parse("9/9/1990 0909", DateTimeFormatter.ofPattern("d/M/yyyy HHmm"));
    ...
    public void testToStringForDeadline() {
        LocalDateTime checkDateAndTime = LocalDateTime.parse("10/10/2000 2010", DateTimeFormatter.ofPattern("d/M/yyyy HHmm"));
