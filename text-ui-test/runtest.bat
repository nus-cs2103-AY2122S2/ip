...
javac  -cp src\main\java -Xlint:none -d bin src\main\java\jarvis\Jarvis.java
IF ERRORLEVEL 1 (
    echo ********** BUILD FAILURE **********
    exit /b 1
)
...
REM run the program, feed jarvis.commands from input.txt file and redirect the output to the ACTUAL.TXT
